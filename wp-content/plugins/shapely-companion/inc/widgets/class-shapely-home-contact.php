...
class Shapely_Home_Contact extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		<section class="contact-section<?php echo $class; ?>">
			<div <?php echo $atts; ?>>
				<div class="container" style="background: url('<?php echo $image_src ?>;'); background-repeat: no-repeat;  background-position: <?php echo $instance['background_position'] ?>">
					<div class="row">
						<div class="col-md-6">
							<div class="">
								<?php
								...
								if ( '' != $title ) {
									echo '<h3 class="go-section-title">' . wp_kses_post( $title ) . '</h3>';
								}
