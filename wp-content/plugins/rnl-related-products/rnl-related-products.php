<?php
/*
Plugin Name: RNL Related Products
...
if(!class_exists('RNLRelatedProductsWidget')){
  class RNLRelatedProductsWidget extends WP_Widget{
    public function __construct(){
      parent::WP_Widget(false, "RNL Related Products");
    }
...
?>
      ...
      <a href="<?php echo esc_url( get_the_permalink($product) ); ?>" >
        <div class = "rl-product rl-padding", style ="display: flex; justify-content: space-between;">
          <div class = " fl-1"><img src="<?php echo get_the_post_thumbnail_url($product); ?>"></div>
          <div class = " fl-2">
            <div class=" rl-title"><?php echo $product->post_title; ?></div>

            <!-- <div class="row"><?php echo wp_trim_words(get_field('description',$product->ID),7); ?></div> -->
          </div>
        </div>
			</a>
...
<?php
  ...
  function register_rnl_related_products(){
    register_widget("RNLRelatedProductsWidget");
  }


  add_action("widgets_init","register_rnl_related_products");
}
