	...
	<div id="content" class="main-container">
		...
		<div  class="rl-container">
			<div class="rl-fullwidth ">
				<?php
		      //$term_image_id = get_term_meta( get_queried_object_id(), 'header_image', true);
		      //$image = wp_get_attachment_image_src($term_image_id,'full' );

			?>
				<!-- <img src = "https://www.prolim.com/wp-content/uploads/2018/09/Blog.jpg" class = "rl-header-img"/> -->

			<img src="<?php echo get_field('header_image',get_queried_object()); ?>" class="rl-header-img" />

		<div class ="man-intro image-box__overlay">
			<h2 class="rl-solution-head">
			<?php
