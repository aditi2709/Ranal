					...
					<div class="with-hover-effect">
						...
						<center>
							<?php if (get_field('downloadable')) {?>
								<button class="go-card-btn show-on-hover" href="<?php echo esc_url( get_the_permalink($industry) ); ?>">Download</button>
							<?php }else{ ?>
							<button class="go-card-btn show-on-hover" href="<?php echo esc_url( get_the_permalink($industry) ); ?>">View</button>
						<?php } ?>
						</center>
					</div>
					</div>
