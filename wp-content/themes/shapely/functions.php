...
function arphabet_widgets_init() {
	...
	register_sidebar( array(
		'name'          => 'Industry right sidebar',
		'id'            => 'industry_right_1',
		'before_widget' => "<div id = 'industry-sidebar' class='widget-area col-md-4'>",
		'after_widget'  => '</div>',
	...
	register_sidebar( array(
			...
			'id' => 'product_right_1',
			'before_widget' => "<div id = 'industry-sidebar' class='widget widget-area col-md-4'>",
			'after_widget' => '</div>',
			'before_title' => '<h4 class="widget-title">',
			'after_title' => '</h4>',
	) );
...
show_admin_bar( false ); // Disable wordpress admin bar in frontend
